...
const Category = () => {
  ...
  return <div className="mt-[120px]">
    <div className="flex flex-col justify-center items-center text-center m-16">
      ...
      <h1 className="text-4xl text-[#310048] font-bold">Explore All categories</h1>
      <h2>You can ignore the pixel density and the actual screen resolution when designing. Instead, design for the effective resolution (the resolution in effective pixels) for a size class.</h2>
      </div>
      <div className="flex flex-wrap justify-center w-[688px] items-center mt-8 gap-2 rounded-xl">
